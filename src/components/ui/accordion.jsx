...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      {...props}>
      {/* Inner div intentionally has no fixed/var height — it must stay
          height:auto so content that resizes after opening (e.g. async data
          replacing a skeleton) isn't clipped. */}
      <div
        className={cn(
